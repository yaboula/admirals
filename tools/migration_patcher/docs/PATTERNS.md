...
- Safe 2-argument bank calls without a QBCore reason, using a stable synthetic migration reason.
- Simple assignment calls where the first SONAR return value preserves the previous boolean result.
