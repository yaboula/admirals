...
| Total items | 5 |
| HIGH abiertos | 0 |
| MEDIUM abiertos | 2 (REQ-FE-001, REQ-FE-002) |
| LOW abiertos | 3 (REQ-FE-003, REQ-FE-004, REQ-FE-005) |
| RESOLVED | 0 (REQ-FE-005 path-C self-resolved) |
| Path A target (Round 2 Backend amendment cycle) | 2 (REQ-FE-001, REQ-FE-002) |
...
**FIN `FE_BACKEND_REQUESTS.md` v0.1 — BANK-FE.0 drafting active.** Bump v0.2/v0.3 conforme add/close items durante drafting C-FE-01/02/03.
