...
--
-- SSoT:
--   docs/technical/03_db_schema.md §3.1 (sonar_accounts canonical full).
...
--
-- NOTAS:
--   - sonar_accounts aquí es un SUBSET minimal (7 columnas core). Las
...
--   - sonar_bridge_idempotency sustituirá al in-memory _idem_store del
...
-- ----------------------------------------------------------------------------
-- 1. sonar_accounts (minimal — 7 cols core).
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 2. sonar_audit_log — operational wrapper audit.
--
...
CREATE TABLE IF NOT EXISTS sonar_audit_log (
  ...
  resource          VARCHAR(64)     NOT NULL COMMENT 'resource que emitió (sonar_core, sonar_bank, ...)',
...
-- ----------------------------------------------------------------------------
-- 3. sonar_bridge_idempotency — DB-backed replacement para S0.2 in-memory.
--
