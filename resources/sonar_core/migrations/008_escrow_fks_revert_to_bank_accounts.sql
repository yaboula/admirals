...
-- Description:
--   Revert de migration 007 — los FKs `sonar_escrows.buyer_account_id` y
...
-- DECISIONES TÉCNICAS:
--
--   D1. TRUNCATE TABLE sonar_escrows PRE-DROP-FK — elimina rows con
...
-- ----------------------------------------------------------------------------
-- 3. Re-add FKs apuntando a sonar_bank_accounts(id) — como diseño original
