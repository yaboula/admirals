...
Config.MigrationsFiles = {
  ...
  '010_bank_audit_ledger.sql',
  '011_bank_compliance_flags.sql',
  '012_bank_status_fsm.sql',
  '013_bank_movements_partitions_extend.sql',
  '014_bank_accounts_owner_type_split.sql',
  '015_bank_movements_category_extend.sql',
  '016_tax_brackets_history_subsidies.sql',
  '017_govt_elections_candidates_votes.sql',
  '018_bank_loans_credit_scores.sql',
  '019_bank_crypto_wallets.sql',
  '020_bank_stocks_transactions_holdings.sql',
  '021_bank_recurring_payments.sql',
  '022_bank_atm_minigame_attempts.sql',
  '023_bank_physical_cards.sql',
  '024_bank_loyalty_points.sql',
  '025_bank_round_ups.sql',
  '026_bank_business_treasuries.sql',
  '027_bank_escrow_releases.sql',
  '028_bank_idempotency_keys.sql',
  ...
  '040_sonar_bank_physical_cards_design_id.sql',
}
