...
// S2.3 mono-theme purge (ADR-016 D2 + D3): light-mode variant prefix removido.
// SONAR es single-theme permanente — las overrides shadcn light/dark-variant
// se consolidan en classes siempre activas (equivalente semántico mono-theme).
// Tokens semánticos preservados (bg-primary / border-border / etc) mapean a
// sonar canonical via globals.css @theme inline bridge.
