/**
 * SONAR Tablet — Map app stub (S2.3).
 *
 * Placeholder hasta S2.5 donde se implementa GPS player marker + POIs nodos
 * SONAR (Granja/Mill/Bakery/Retail). NUI bridge ad-hoc
 * `sonar:tablet:map:getNodes` — SPRINT_PLAN_S2 §2.2.3 consumer pattern
 * temporal (catalog promotion deferred S3).
 *
 * Lazy-loaded chunk via React.lazy en App.tsx — respeta D6 budget.
 */
  ...
  return (
    <div className="flex h-full flex-col bg-sonar-black">
      ...
      <main className="flex flex-1 flex-col items-center justify-center gap-3 px-8">
        ...
        <p className="text-sm text-sonar-white/60">Coming S2.5</p>
