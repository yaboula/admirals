...
-- -----------------------------------------------------------------------------
-- RegisterItem — registra item Admirals para que GiveItem lo acepte.
-- -----------------------------------------------------------------------------
...
-- RemoveItem
-- -----------------------------------------------------------------------------
function NativeInventory.RemoveItem(citizenId, item_name, count, admirals_item_id)
  ...
  -- Si admirals_item_id specified, validar que matchea antes de remove.
  if admirals_item_id then
    local mid = bucket.metadata and bucket.metadata.admirals_item_id
    if mid ~= admirals_item_id then
      return false, 'NOT_FOUND'
    end
  end
