-- =============================================================================
-- Admirals Bridges — adapters/identity/native.lua
--
...
--   stripped → usado como `citizenId`. Permite Admirals standalone sin
--   framework externo.
--
-- Lifecycle:
--   'playerJoining' + `Wait(500)` para que identifiers estén ready → fire
--   'admirals:bridge:_identityPlayerLoaded'.
--   'playerDropped' → fire 'admirals:bridge:_identityPlayerDropped'.
--
...
AddEventHandler('playerDropped', function(reason)
  ...
  if cid then
    TriggerEvent('admirals:bridge:_identityPlayerDropped', cid, src, reason or 'unknown')
