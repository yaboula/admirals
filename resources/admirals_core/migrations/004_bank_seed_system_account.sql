...
--   - 003_bank_schema (admirals_bank_accounts + admirals_bank_movements).
--
...
--   docs/technical/03_db_schema.md §4.1 (admirals_bank_accounts CHECK XOR).
--
...
--
--       Founder recomendó type='escrow' MÁS opción (a) "admirals_accounts
...
--         type = 'personal'
--         owner_account_id = SYSTEM admirals_accounts ficticio (creado aquí).
--
...
--       crear admirals_companies ficticio cuando esa tabla exista (S2 schema).
--
...
--
--   D5. La runner tracking (admirals_schema_versions) ya garantiza que esta
...
-- ----------------------------------------------------------------------------
-- 1. SYSTEM admirals_accounts ficticio.
--
...
-- el literal 'SYSTEM').
-- framework_source = 'admirals_core' (no proviene de qbox/esx — server-managed).
-- ----------------------------------------------------------------------------
INSERT IGNORE INTO admirals_accounts
...
-- ----------------------------------------------------------------------------
-- 2. SYSTEM admirals_bank_accounts (IBAN AD-SYS0-0000-0001).
--
...
-- ----------------------------------------------------------------------------
INSERT IGNORE INTO admirals_bank_accounts
...
-- source_resource = 'admirals_core' (originador del seed).
-- ----------------------------------------------------------------------------
...
SELECT
  ...
  NULL, NULL, NULL,
  'a0000000-0000-0000-0000-00000000seed', NULL, 'admirals_core'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM admirals_bank_movements
