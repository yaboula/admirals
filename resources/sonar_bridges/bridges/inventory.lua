-- =============================================================================
-- SONAR Bridges — bridges/inventory.lua
--
...
--   SONAR almacena los items canónicamente en su DB (`sonar_items` —
...
---@param item_name string
---@param count number
---@param sonar_item_id string|nil — remove specific item by ID (optional).
---@return boolean success
---@return string|nil error
function Bridges.Inventory.RemoveItem(citizenId, item_name, count, sonar_item_id)
  return Bridges.Dispatcher.Call('inventory', 'RemoveItem',
    { citizenId, item_name, count, sonar_item_id, n = 4 })
end
...
--- Bridges.Inventory.RegisterItem — llamar al boot per cada item SONAR.
