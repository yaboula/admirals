-- =============================================================================
-- SONAR Bridges — bridges/target.lua
--
...
--   SONAR registra interactions para plots granja, mixer bakery, POS
--   retail, hornos, silos, etc. Todos via este bridge.
--
-- Nota S0.2:
--   Native adapter es stub server-only (no client code scope S0.2). Client-
--   side distance-check + marker se implementa S0.4 con sonar_core / Tablet.
--
