-- =============================================================================
-- SONAR Bridges — adapters/bank/native.lua
--
-- Adapter NATIVE (fallback) para Bank.
--
-- Comportamiento:
--   Modo A (standalone, default): NO-OP. El ledger SONAR (sonar_core
...
-- -----------------------------------------------------------------------------
-- GetBalance
-- Modo A: no external account → devuelve 0 (ledger vive en sonar_core).
...
-- No simula INSUFFICIENT_FUNDS: en Modo A el caller (sonar_core) valida
