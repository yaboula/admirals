-- =============================================================================
-- SONAR Bridges — adapters/target/ox_target.lua
--
...
--   2. TriggerClientEvent(-1, 'sonar:bridge:target:*') a clientes conectados
--      para que client code llame exports.ox_target localmente.
--
-- Comportamiento S0.4+:
--   sonar_bridges/client/target_ox_consumer.lua escucha:
--     'sonar:bridge:target:addBoxZone'  → exports.ox_target:addBoxZone(...)
--     'sonar:bridge:target:addEntity'   → exports.ox_target:addEntity(...)
--     'sonar:bridge:target:addModel'    → exports.ox_target:addModel(...)
--     'sonar:bridge:target:removeZone'  → exports.ox_target:removeZone(...)
...
function OxTarget.AddBoxZone(id, coords, size, heading, options)
  ...
  TriggerClientEvent('sonar:bridge:target:addBoxZone', -1, id, coords, size, heading, options)
...
function OxTarget.AddEntity(entity_handle, options)
  ...
  TriggerClientEvent('sonar:bridge:target:addEntity', -1, entity_handle, options)
...
function OxTarget.AddModel(model_hashes, options)
  ...
  TriggerClientEvent('sonar:bridge:target:addModel', -1, model_hashes, options)
...
function OxTarget.RemoveZone(id)
  if _zones[id] then
    _zones[id] = nil
    TriggerClientEvent('sonar:bridge:target:removeZone', -1, id)
