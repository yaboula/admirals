  ...
  return (
    <Card variant="glass" padding="none" className="relative h-full min-h-0 overflow-hidden rounded-[1.75rem] border-white/10">
      ...
      <div className="relative h-full min-h-0 flex flex-col p-5 2xl:p-6">
        ...
        <div className="relative mt-3 h-[224px] shrink-0" style={{ perspective: '1000px' }}>
          {cards[2] && (
            <div className="absolute left-[18%] right-[-4%] top-0 z-0 opacity-90" style={{ transform: 'translateY(-2px) rotateX(0deg) rotateZ(0.5deg) scale(0.84)', transformOrigin: 'center top' }}>
              <CardVisual card={cards[2]} compact className="shadow-none" />
            </div>
          )}
          {cards[1] && (
            <div className="absolute left-[9%] right-[-2%] top-[34px] z-10 opacity-95" style={{ transform: 'rotateZ(-0.35deg) scale(0.91)', transformOrigin: 'center top' }}>
